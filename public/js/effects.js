(function() {
    ...
    window.addDataStreams = function() {
        ...
        streamL.style.cssText = 'position:fixed;top:50px;left:78px;width:24px;height:calc(100vh - 78px);overflow:hidden;pointer-events:none;z-index:99;';
    ...
    window.addCornerHUD = function() {
        ...
        var corners = [
            ...
            { id: 'hcc-hud-bl', css: 'bottom:34px;left:84px;border-bottom:2px solid rgba(0,183,255,0.5);border-left:2px solid rgba(0,183,255,0.5);' },
            { id: 'hcc-hud-tl', css: 'top:56px;left:84px;border-top:2px solid rgba(0,183,255,0.4);border-left:2px solid rgba(0,183,255,0.4);' },
